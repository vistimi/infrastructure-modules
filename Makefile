...
aws-auth:
	make -f Makefile_infra aws-auth AWS_PROFILE_NAME=${ACCOUNT_AWS_PROFILE_NAME} AWS_REGION_NAME=${ACCOUNT_AWS_REGION_NAME} AWS_ACCESS_KEY=${ACCOUNT_AWS_ACCESS_KEY} AWS_SECRET_KEY=${ACCOUNT_AWS_SECRET_KEY}
